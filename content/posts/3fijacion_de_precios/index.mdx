...
Ya lo dijo Charles Darwin hace 200 años

> No es el más fuerte de las especies el que sobrevive, tampoco es el más inteligente el que sobrevive. Es aquel que es más adaptable al cambio. 

Las empresas no son diferentes a los organismos de los que hablaba Darwin, ellas también aprenden y evolucionan a su entorno. Justo esa adaptabilidad a la que se refiere Darwin es de lo que se trata el precio para una empresa, un camino que te fuerza a seguir evolucionando en pro de sobrevivir. 

> #### **La importancia de fijar el precio correcto.**

Mi subtítulo es engañoso, no existe como tal -el precio definitivo- pero lo que sí existe es el precio correcto por periodos de tiempo, me explico:

El precio es el resultado de una constante experimentación que –supone- debe hacerse cada cierto tiempo. La razón de experimentar cada periodo es debido a los distintos cambios a los que se somete una empresa. Uno de estos cambios puede ser el adherir más características, otro de ellos es encontrar nuevos usos para el producto, nuevos segmentos, etc. Todo esto quiere decir que la percepción del valor que tiene el cliente para con la empresa aumenta y como lo vimos en la primera entrada… mayor valor es igual a mayor rango lo que te da más libertad para mover tu precio.

Una buena fijación puede ayudarte en:
...
Si, probablemente todavía no entiendas como el precio impacta todo esto pero no te preocupes, lo veremos más adelante.

> #### **¿Cómo fijamos un precio adecuado?**

La fijación es básicamente un proceso que busca entender a profundidad 3 cosas:

* Qué problema solucionas
* El segmento al que apuntas y sus características
* Que quieren tus personas y cuanto están dispuestos a pagar por tu producto  (precio)
...
Empiezan los síntomas… la empresa comienza a detectar que sus procesos se vuelven tediosos, que la documentación no se entrega y que los reportes no reflejan lo deseado.

Ahora llegan los problemas… las ventas de la empresa bajan, la empresa pierde mercado frente a sus competidores y, por consecuencia, se vuelve más difícil crecer.

Eventualmente encuentras que la causa raíz es la falta de un sistema de gestión, te pones manos a la obra y se te ocurre un producto que pueda solucionar este problema.

Vamos más profundo con un breve cuestionario:

* ¿Quiénes más tienen este problema?
* ¿Cuál sería el impacto de resolver este problema?
* ¿Cuántos segmentos están afectados por el problema?

Entonces comprendes que no solo las empresas tienen problemas de gestión, también lo tienen las universidades, las organizaciones no lucrativas, los gobiernos y ¡hasta los estudiantes!
