---
title: "Una introduccion al valor y las estructuras de precios"
date: 2021-05-05
tags: 
    - Precios 
---
...
Sigamos trabajando en el ejemplo anterior. Imaginemos que sumando costos fijos y variables, en promedio te costaría producir 3$ cada platillo. Esto te da un rango de 7$ donde puedes colocar el precio que desees. 
...
Preguntar, entender y visualizar el rango de valor te permite construir un producto respetando la percepción de tu segmento y su disponibilidad de pago, obtener ganancias para re-invertir y por consecuente seguir generando valor. Podemos decir que el propósito de una compañía es mantener ese valor, encontrar más valor (a través de acciones o nuevos productos) y seguir rascando esa “subjetividad” de mercado que les permita crecer.

Creo que hemos aterrizado con éxito el concepto de valor. Podemos concluir con que es un approach interesante para construir productos y para ver el funcionamiento subjetivo del producto para con el mercado. Es tiempo adentrarnos a la estructura de precios.
...
El precio es el monto que esperas recibir por un producto que vendes, ese monto suele ser representado por unidades monetaria pero en algunas partes puede ser representado por cabezas de ganado.

A su vez, la estructura de precios es un enfoque que muestra la relación entre tu fijación de precios y tu tu producto. La estructura abarca 4 elementos:

Características  —> Valor —> Costes —> Precio
